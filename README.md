...
Limitations
- If you launch the shortcut from outside Control Center, or modify the auto-lock settings without going through the shortcut, the Control Center widget name won’t be updated to reflect the new status – the next time you launch it from Control Center, it will be corrected immediately, though</li>
