...
Limitations
- If you launch the shortcut from outside Control Center, or modify the auto-lock settings without going through the shortcut, the widget’s name won’t be updated to reflect the new state, but it will be be corrected the next time you use the widget, though</li>
